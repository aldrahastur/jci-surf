...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = User::with(['roles', 'jci_chapter'])->select(sprintf('%s.*', (new User())->table));
            ...
            $table->addColumn('jci_chapter_name', function ($row) {
    ...
    public function create()
    {
        ...
        return view('admin.users.create', compact('roles', 'jci_chapters'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('admin.users.edit', compact('roles', 'jci_chapters', 'user'));
    }
